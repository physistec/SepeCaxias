...
<body <?php body_class(); ?> role="document">
	...
	<header id="masthead" class="site-header" role="banner" style="margin-bottom: -15px;">
			...
			<!--div class="row">
				<div class="col-md-12">
					<div class="rsociais" style="margin: 10px 10px -60px;">
						<ul>
							<li><a class="btn btn-social-icon btn-facebook" href="https://www.facebook.com/Alexandre-Abandonou-a-Minha-Escola-1172269582797897" target="_blank"><i class="fa fa-facebook"></i></a></li>
						</ul>
					</div>

					<!--div class="alame" style="border: none;"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/campanhas/alame_top.jpg" title="Alexandre abandonou minha escola" /></div>
				</div>
			</div-->
