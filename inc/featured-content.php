...
class Featured_Content {
	...
	public static function enqueue_scripts() {
		wp_enqueue_script( 'featured-content-suggest', get_template_directory_uri() . '/scripts/featured-content-admin.js', array( 'jquery', 'suggest' ), '20131022', true );
	}
